...
function calcularPreciosCierre()
{
	...
	if (valorCierre != null && coeficiente != null)
	{
		...
		if ( registros.length > 0 )
		{
			...
			{
				if ( registros[0].attributes["atos_p1"] != null )   pCoeficiente1 =  registros[0].attributes["atos_p1"].value;				
				if ( registros[0].attributes["atos_p2"] != null )   pCoeficiente2 =  registros[0].attributes["atos_p2"].value;
				if ( registros[0].attributes["atos_p3"] != null )	pCoeficiente3 =  registros[0].attributes["atos_p3"].value;
				if ( registros[0].attributes["atos_p4"] != null )	pCoeficiente4 =  registros[0].attributes["atos_p4"].value;
				if ( registros[0].attributes["atos_p5"] != null )	pCoeficiente5 =  registros[0].attributes["atos_p5"].value;
				if ( registros[0].attributes["atos_p6"] != null )	pCoeficiente6 =  registros[0].attributes["atos_p6"].value;	
			}
		}
		...
		{
			if (pCoeficiente1 != null) precio1 = parseFloat(((margen + valorCierre + costeGestion) * pCoeficiente1) / 100);
			if (pCoeficiente2 != null) precio2 = parseFloat(((margen + valorCierre + costeGestion) * pCoeficiente2) / 100);
			if (pCoeficiente3 != null) precio3 = parseFloat(((margen + valorCierre + costeGestion) * pCoeficiente3) / 100);
			if (pCoeficiente4 != null) precio4 = parseFloat(((margen + valorCierre + costeGestion) * pCoeficiente4) / 100);
			if (pCoeficiente5 != null) precio5 = parseFloat(((margen + valorCierre + costeGestion) * pCoeficiente5) / 100);
			if (pCoeficiente6 != null) precio6 = parseFloat(((margen + valorCierre + costeGestion) * pCoeficiente6) / 100);

			if (pCoeficiente1 != null) precioSC1 = parseFloat(((margen + valorCierre ) * pCoeficiente1) / 100);
			if (pCoeficiente2 != null) precioSC2 = parseFloat(((margen + valorCierre ) * pCoeficiente2) / 100);
			if (pCoeficiente3 != null) precioSC3 = parseFloat(((margen + valorCierre ) * pCoeficiente3) / 100);
			if (pCoeficiente4 != null) precioSC4 = parseFloat(((margen + valorCierre ) * pCoeficiente4) / 100);
			if (pCoeficiente5 != null) precioSC5 = parseFloat(((margen + valorCierre ) * pCoeficiente5) / 100);
			if (pCoeficiente6 != null) precioSC6 = parseFloat(((margen + valorCierre ) * pCoeficiente6) / 100);     
		}
