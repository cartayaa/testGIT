...
function cargaDesdeOferta(formContext, ofertaid) {
    ...
    if (ofertaid != null) {
        var fetchXml =
            ...
            Xrm.WebApi.retrieveMultipleRecords("atos_oferta", "?$filter= atos_ofertaid eq '" + ofertaid + "'&$expand=atos_instalacionid,atos_instalaciongasid").then(
        // var registros = XrmServiceToolkit.Soap.Fetch(fetchXml);
...
/**
// <summary>
// Se ejecuta en el OnLoad del formulario para cargar datos de la oferta cuando se trata de nuevo contrato y para inicializar la cuenta bancaria propia.
// </summary>
// <remarks>
