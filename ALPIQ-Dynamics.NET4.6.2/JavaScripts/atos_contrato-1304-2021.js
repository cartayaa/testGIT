...
debugger;
    try {                                                                                   /*223231*/
        ...
        Xrm.WebApi.online.retrieveRecord("atos_oferta", statement).then(                    /*223231*/    
        function success(result) {                                                          /*223231*/
 
            if (result != null && result.entities != null && result.entities.length > 0) {
                
                var oferta = result.entities[0]; //Carga de la parte comun de contrato indiferentemenete sea una oferta con instalacion power o gas
...
/*22339*/           // formContext.getAttribute("atos_fechafindefinitiva").setValue(new Date(oferta.atos_fechafin.substr(0, 10)));
                ...
                //Tipo de producto
// NOTA Revisar este codigo porque falla cuando vienes de una oferta
...
debugger;
    if (result != null && result.entities != null && result.entities.length > 0) {
        ...
        if (oferta["atos_numclicsmensual"] != mnull) {
...
/*22339*/           // formContext.getAttribute("atos_fechafindefinitiva").setValue(new Date(oferta.atos_fechafin.substr(0, 10)));
        ...
        if( oferta["rz.atos_numerodedocumento"] != null) {
        //if (oferta.atos_numerodocumento != null) {
          //  formContext.getAttribute("atos_numerodocumento").setValue(oferta.atos_numerodocumento);
          formContext.getAttribute("atos_numerodocumento").setValue( oferta["rz.atos_numerodedocumento"]);
            formContext.getAttribute("atos_numerodocumento").setSubmitMode("always");
        }
